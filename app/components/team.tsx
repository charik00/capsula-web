...
export function Team() {
  ...
  const team = [
    ...
    {
      name: "Самуил Горелик",
      role: "Профессор технических наук",
      image: null,
      initials: "СГ",
      experience: "Консультант проекта",
      approach: "Экспертная научно-техническая поддержка методики",
    },
    {
      name: "Алекс Белый",
    ...
    {
      name: "Наоми Кравченко",
      role: "Ведущий психолог, психотерапевт",
      image: null,
      initials: "НК",
      experience: "Ведущий психолог, психотерапевт",
      approach: "Работа с эмоциональными триггерами и устойчивыми изменениями",
    },
    {
      name: "Алиса Роках",
      role: "НЛП специалист",
