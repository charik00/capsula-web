...
export function Hero() {
  ...
  return (
    <section className="relative h-screen flex items-start md:items-center justify-center overflow-visible">
      ...
      <div className="md:hidden absolute bottom-[176px] left-1/2 -translate-x-1/2 z-[100] w-full px-6">
        <button
          onClick={openModal}
      ...
      <div className="absolute bottom-[80px] md:bottom-0 left-1/2 -translate-x-1/2 md:translate-y-1/2 z-[100] bg-[#F5F3ED] p-4 md:p-8 shadow-2xl border-2 border-[#302012]">
